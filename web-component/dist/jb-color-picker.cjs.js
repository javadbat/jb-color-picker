...
function c(e) {
	const t = l(e.r), r = l(e.g), a = l(e.b), s = .4122214708 * t + .5363325363 * r + .0514459929 * a, n = .2119034982 * t + .6806995451 * r + .1073969566 * a, o = .0883024619 * t + .2817188376 * r + .6299787005 * a, c = Math.cbrt(s), h = Math.cbrt(n), u = Math.cbrt(o), p = 1.9779984951 * c - 2.428592205 * h + .4505937099 * u, d = .0259040371 * c + .7827717662 * h - .808675766 * u;
	return i({
		colorSpace: "oklch",
...
var S = class extends v {
	...
	set value(e) {
		const t = "string" == typeof e ? d(e) : !e || "rgb" !== e.colorSpace && "oklch" !== e.colorSpace ? null : i(e);
	...
	#s() {
		...
		}), this.elements.alpha.addEventListener("change", () => this.#o("change")), this.elements.surface.addEventListener("pointerdown", (e) => this.#u(e)), this.elements.surface.addEventListener("pointermove", (e) => this.#p(e)), this.elements.surface.addEventListener("pointerup", (e) => this.#d(e)), this.elements.surface.addEventListener("pointercancel", (e) => this.#d(e)), this.elements.surface.addEventListener("keydown", (e) => this.#b(e));
	}
	#u(e) {
