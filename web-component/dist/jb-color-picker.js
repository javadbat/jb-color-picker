...
function p(e) {
	...
	return t.startsWith("#") ? function(e) {
		...
		return null === s || null === n || null === l || null === o ? null : i({
			colorSpace: "oklch",
			l: s,
			c: n,
			h: l,
...
var S = class extends HTMLElement {
	...
	#l(e = !0) {
		...
		const a = this.#v();
		this.elements.surfaceCursor.style.left = 100 * a.x + "%", this.elements.surfaceCursor.style.top = 100 * a.y + "%", this.elements.surface.setAttribute("aria-label", "rgb" === this.#e.colorSpace ? "Saturation and brightness" : "Chroma and lightness"), this.elements.surface.setAttribute("aria-description", t), this.#i && (this.#i.ariaDescription = t), this.#S(), e && this.#k();
	}
	#S() {
	...
	#k() {
		...
		for (let e = 0; e < i; e++) for (let r = 0; r < a; r++) {
			const l = r / (a - 1), o = e / (i - 1), c = "rgb" === this.#e.colorSpace ? n(this.#r, l, 1 - o) : h({
				colorSpace: "oklch",
				l: 1 - o,
				c: l * t,
				h: this.#e.h,
...
export { S as JBColorPickerWebComponent, t as MAX_OKLCH_CHROMA, r as clamp, d as colorToCss, u as convertColor, n as hsvToRgb, i as normalizeColor, a as normalizeHue, h as oklchToRgb, p as parseColor, s as rgbToHsv, c as rgbToOklch };
