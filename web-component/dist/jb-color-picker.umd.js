(function(e, t) {
	...
	function n({ r: e, g: t, b: r }) {
		const a = e / 255, s = t / 255, n = r / 255, o = Math.max(a, s, n), l = o - Math.min(a, s, n);
		let c = 0;
		return 0 !== l && (c = o === a ? (s - n) / l % 6 * 60 : o === s ? 60 * ((n - a) / l + 2) : 60 * ((a - s) / l + 4)), {
			h: i(c),
			s: 0 === o ? 0 : l / o,
			v: o
		};
	...
	function o(e, t, r, a = 1) {
		const n = i(e), o = r * t, l = o * (1 - Math.abs(n / 60 % 2 - 1)), c = r - o, h = Math.floor(n / 60), [u, d, p] = 0 === h ? [
			o,
			l,
			0
		] : 1 === h ? [
	...
	function h(e) {
		const t = l(e.r), r = l(e.g), a = l(e.b), i = .4122214708 * t + .5363325363 * r + .0514459929 * a, n = .2119034982 * t + .6806995451 * r + .1073969566 * a, o = .0883024619 * t + .2817188376 * r + .6299787005 * a, c = Math.cbrt(i), h = Math.cbrt(n), u = Math.cbrt(o), d = 1.9779984951 * c - 2.428592205 * h + .4505937099 * u, p = .0259040371 * c + .7827717662 * h - .808675766 * u;
		return s({
			colorSpace: "oklch",
	...
	function u(e) {
		const t = i(e.h) * Math.PI / 180, r = e.c * Math.cos(t), a = e.c * Math.sin(t), n = (e.l + .3963377774 * r + .2158037573 * a) ** 3, o = (e.l - .1055613458 * r - .0638541728 * a) ** 3, l = (e.l - .0894841775 * r - 1.291485548 * a) ** 3;
		return s({
			colorSpace: "rgb",
			r: c(4.0767416621 * n - 3.3077115913 * o + .2309699292 * l),
			g: c(-1.2684380046 * n + 2.6097574011 * o - .3413193965 * l),
			b: c(-.0041960863 * n - .7034186147 * o + 1.707614701 * l),
			alpha: e.alpha
		});
	}
	function d(e, t) {
	...
	function p(e) {
		const t = s(e);
		return "rgb" === t.colorSpace ? `rgb(${t.r} ${t.g} ${t.b} / ${b(t.alpha)})` : `oklch(${b(t.l)} ${b(t.c)} ${b(t.h)} / ${b(t.alpha)})`;
	}
	function b(e) {
	...
	var f = class extends HTMLElement {
		...
		attributeChangedCallback(e, t, r) {
			t !== r && ("color-space" !== e || "rgb" !== r && "oklch" !== r || r === this.#e.colorSpace || (this.#e = d(this.#e, r), this.#n()), this.#s());
		}
		get value() {
			return { ...this.#e };
		}
		set value(e) {
			!e || "rgb" !== e.colorSpace && "oklch" !== e.colorSpace || (this.#e = s(e), this.#n(), this.getAttribute("color-space") !== this.#e.colorSpace && this.setAttribute("color-space", this.#e.colorSpace), this.#s());
		}
		get valueAsString() {
			return p(this.#e);
		}
		...
		set colorSpace(e) {
			"rgb" !== e && "oklch" !== e || (e !== this.#e.colorSpace && (this.#e = d(this.#e, e), this.#n()), this.getAttribute("color-space") !== e && this.setAttribute("color-space", e), this.#s());
		}
		get alphaEnabled() {
		...
		#f(e, t) {
			"rgb" === this.#e.colorSpace ? this.#e = o(this.#t, e, 1 - t, this.#e.alpha) : this.#e = s({
				...this.#e,
				c: e * r,
				l: 1 - t
			}), this.#s(!1);
		...
		#l(e) {
			if ("rgb" === this.#e.colorSpace) {
				const t = n(this.#e);
				this.#t = e, this.#e = o(e, t.s, t.v, this.#e.alpha);
			} else this.#e = s({
				...this.#e,
				h: e
			});
		...
		#h(e) {
			...
			Number.isFinite(a) ? (this.#e = s({
				...this.#e,
				[r]: a
			}), this.#n(), this.#s(), this.#o("input"), this.#o("change")) : this.#v();
		}
		#n() {
			if ("rgb" === this.#e.colorSpace) {
				const e = n(this.#e);
		...
		#v() {
			...
			for (const t of m[this.#e.colorSpace]) {
		...
		#k() {
			...
			for (let e = 0; e < i; e++) for (let t = 0; t < a; t++) {
				const n = t / (a - 1), l = e / (i - 1), c = "rgb" === this.#e.colorSpace ? o(this.#t, n, 1 - l) : u({
					colorSpace: "oklch",
					l: 1 - l,
					c: n * r,
					h: this.#e.h,
	...
	customElements.get("jb-color-picker") || customElements.define("jb-color-picker", f), e.JBColorPickerWebComponent = f, e.MAX_OKLCH_CHROMA = r, e.clamp = a, e.colorToCss = p, e.convertColor = d, e.hsvToRgb = o, e.normalizeColor = s, e.normalizeHue = i, e.oklchToRgb = u, e.rgbToHsv = n, e.rgbToOklch = h;
}));
