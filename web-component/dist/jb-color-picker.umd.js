(function(e, t) {
	"object" == typeof exports && "undefined" != typeof module ? t(exports, require("jb-core/theme")) : "function" == typeof define && define.amd ? define(["exports", "jb-core/theme"], t) : t((e = "undefined" != typeof globalThis ? globalThis : e || self).JBColorPicker = {}, e.JBCoreTheme);
})(this, (function(e, t) {
	...
	function s(e) {
		...
		return "oklch" === e.colorSpace ? {
			...
			colorSpace: "rgb",
			r: Math.round(a(e.r, 0, 255)),
			g: Math.round(a(e.g, 0, 255)),
			b: Math.round(a(e.b, 0, 255)),
			alpha: t
		};
	}
	function n({ r: e, g: t, b: r }) {
		const a = e / 255, s = t / 255, n = r / 255, l = Math.max(a, s, n), o = l - Math.min(a, s, n);
		let c = 0;
		return 0 !== o && (c = l === a ? (s - n) / o % 6 * 60 : l === s ? 60 * ((n - a) / o + 2) : 60 * ((a - s) / o + 4)), {
			h: i(c),
			s: 0 === l ? 0 : o / l,
			v: l
		};
	}
	function l(e, t, r, a = 1) {
		const n = i(e), l = r * t, o = l * (1 - Math.abs(n / 60 % 2 - 1)), c = r - l, h = Math.floor(n / 60), [u, d, p] = 0 === h ? [
			l,
			o,
			0
		] : 1 === h ? [
	...
	function c(e) {
		return a(255 * (e <= .0031308 ? 12.92 * e : 1.055 * e ** (1 / 2.4) - .055), 0, 255);
	}
	function h(e) {
	...
	function u(e) {
		const t = i(e.h) * Math.PI / 180, r = e.c * Math.cos(t), a = e.c * Math.sin(t), n = (e.l + .3963377774 * r + .2158037573 * a) ** 3, l = (e.l - .1055613458 * r - .0638541728 * a) ** 3, o = (e.l - .0894841775 * r - 1.291485548 * a) ** 3;
		return s({
			colorSpace: "rgb",
	...
	function d(e, t) {
		const r = s(e);
		return r.colorSpace === t ? r : "rgb" === r.colorSpace ? h(r) : u(r);
	}
	function p(e) {
		const t = s(e);
		return "rgb" === t.colorSpace ? `rgb(${t.r} ${t.g} ${t.b} / ${v(t.alpha)})` : `oklch(${v(t.l)} ${v(t.c)} ${v(t.h)} / ${v(t.alpha)})`;
	}
	function b(e) {
		...
		return t.startsWith("#") ? function(e) {
			...
			const n = a.map(m), l = void 0 === i ? 1 : f(i);
	...
	var S = class extends HTMLElement {
		...
		connectedCallback() {
			...
			this.#t = "rgb" === e || "oklch" === e ? e : null, this.#t && this.#t !== this.#e.colorSpace && (this.#e = d(this.#e, this.#t), this.#n()), this.#l(), this.dispatchEvent(new CustomEvent("load", {
				bubbles: !0,
				composed: !0
		...
		attributeChangedCallback(e, t, r) {
			t !== r && ("color-space" === e && (this.#t = "rgb" === r || "oklch" === r ? r : null, this.#t && this.#t !== this.#e.colorSpace && (this.#e = d(this.#e, this.#t), this.#n())), this.#l());
		}
		get value() {
			return p(this.#e);
		}
		set value(e) {
			const t = "string" == typeof e ? b(e) : !e || "rgb" !== e.colorSpace && "oklch" !== e.colorSpace ? null : s(e);
			t && (this.#e = this.#t ? d(t, this.#t) : t, this.#n(), this.#l());
		}
		get valueObject() {
			return { ...this.#e };
		}
		...
		set colorSpace(e) {
			...
			"rgb" !== e && "oklch" !== e || (this.#t = e, e !== this.#e.colorSpace && (this.#e = d(this.#e, e), this.#n()), this.getAttribute("color-space") !== e && this.setAttribute("color-space", e), this.#l());
		}
		get alphaEnabled() {
		...
		#s() {
			this.elements.spaceButtons.forEach(((e) => {
				e.addEventListener("click", (() => {
					...
					null === this.#t && t !== this.#e.colorSpace && (this.#e = d(this.#e, t), this.#n(), this.#l(), this.#o("input"), this.#o("change"));
				}));
			...
			})), this.elements.alpha.addEventListener("change", (() => this.#o("change"))), this.elements.fields.addEventListener("change", ((e) => this.#u(e))), this.elements.surface.addEventListener("pointerdown", ((e) => this.#d(e))), this.elements.surface.addEventListener("pointermove", ((e) => this.#p(e))), this.elements.surface.addEventListener("pointerup", ((e) => this.#b(e))), this.elements.surface.addEventListener("pointercancel", ((e) => this.#b(e))), this.elements.surface.addEventListener("keydown", ((e) => this.#m(e)));
		}
		#d(e) {
		...
		#m(e) {
			...
			e.preventDefault();
			const t = e.shiftKey ? .1 : .01, r = this.#v(), a = r.x + ("ArrowRight" === e.key ? t : "ArrowLeft" === e.key ? -t : 0), i = r.y + ("ArrowDown" === e.key ? t : "ArrowUp" === e.key ? -t : 0);
			this.#g(Math.min(1, Math.max(0, a)), Math.min(1, Math.max(0, i))), this.#o("input"), this.#o("change");
		}
		#g(e, t) {
			"rgb" === this.#e.colorSpace ? this.#e = l(this.#r, e, 1 - t, this.#e.alpha) : this.#e = s({
				...this.#e,
				c: e * r,
				l: 1 - t
			}), this.#l(!1);
		...
		#c(e) {
			if ("rgb" === this.#e.colorSpace) {
				const t = n(this.#e);
				this.#r = e, this.#e = l(e, t.s, t.v, this.#e.alpha);
			} else this.#e = s({
				...this.#e,
				h: e
			});
		...
		#S() {
			...
			if (!t) return;
			const { width: a, height: i } = e, s = t.createImageData(a, i);
			for (let e = 0; e < i; e++) for (let t = 0; t < a; t++) {
				const n = t / (a - 1), o = e / (i - 1), c = "rgb" === this.#e.colorSpace ? l(this.#r, n, 1 - o) : u({
					colorSpace: "oklch",
					l: 1 - o,
					c: n * r,
					h: this.#e.h,
				...
				s.data[h] = c.r, s.data[h + 1] = c.g, s.data[h + 2] = c.b, s.data[h + 3] = 255;
			}
	...
	customElements.get("jb-color-picker") || customElements.define("jb-color-picker", S), e.JBColorPickerWebComponent = S, e.MAX_OKLCH_CHROMA = r, e.clamp = a, e.colorToCss = p, e.convertColor = d, e.hsvToRgb = l, e.normalizeColor = s, e.normalizeHue = i, e.oklchToRgb = u, e.parseColor = b, e.rgbToHsv = n, e.rgbToOklch = h;
}));
